...
def register_user():
    ...
    if flag:
        ...
        query = "INSERT into Information (first_name, last_name, email, password) VALUES (:first_name, :last_name, :email, :password)"
...
def success():
    try:
        query = "SELECT * from Information WHERE id=:user_id"
        data = {
